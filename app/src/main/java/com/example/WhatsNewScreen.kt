...
val changelog = listOf(
    ChangelogEntry(
        ...
        listOf(
            ...
            "MP4 export now renders clip positioning/transform keyframes, crop, filters, blur, static text, captions, stickers, drawings, frames, image overlays, supported fades, and separate audio tracks.",
