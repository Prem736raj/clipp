...
val changelog = listOf(
    ChangelogEntry(
        ...
        listOf(
            ...
            "MP4 export now renders clip positioning/transform/crop keyframes, crop, filters, blur, mirror, shake, comic-book/pencil-sketch/pop-art style effects, static text, captions, stickers, drawings, frames, supported text/sticker/image/video-overlay animations, photo-overlay chroma key, image and video overlays, supported fades, separate audio tracks, and volume keyframes/fade envelopes.",
