...
val changelog = listOf(
    ChangelogEntry(
        ...
        listOf(
            ...
            "MP4 export now renders clip positioning/transform keyframes, crop, filters, blur, static text, captions, stickers, drawings, frames, supported text/sticker/image-overlay animations, photo-overlay chroma key, image overlays, supported fades, separate audio tracks, and volume keyframes/fade envelopes.",
