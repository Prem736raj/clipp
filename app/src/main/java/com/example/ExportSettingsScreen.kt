                        ...
                        Row(modifier = Modifier.padding(16.dp), verticalAlignment = Alignment.Top) {
                            ...
                            Text(
                                if (unsupportedReasons.isNotEmpty()) {
                                    ...
                                    "The current renderer includes clip positioning and transform/crop keyframes, static text, captions, supported text/sticker/image/GIF/video-overlay animations, drawings, frames, image overlays, GIF/video overlays, photo/video-overlay chroma key, crop, filters, shader distortion effects, sampled speed-curve automation with pitch preservation, simple photo/video-source transitions, audio EQ/pitch/delay/reverb/distortion, volume keyframes/fade envelopes, and separate audio tracks. Masks, blend modes, transitions on curved clips, noise reduction, voice effects, ducking, and audio crossfade are not enabled."
                                },
