...
- Export now renders basic constant speed (with pitch preservation option), rotation, horizontal/vertical flip, per-clip volume, mute, trims, still-image durations, crop, supported filters/adjustments, Gaussian blur, static text/captions/stickers/drawings/frames, image overlays, fade-to-black/white, and separate audio tracks through Media3 effects/audio processors. Animated effects, video overlays, unsupported transitions, and advanced audio automation remain blocked.
