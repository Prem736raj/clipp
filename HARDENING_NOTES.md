...
- New edits now prevent known preview/export mismatches: speed curves, unsupported effects, push transitions, overlay masks/blend modes/slide animations, GIF chroma key, overlay borders/shadows, and 3D text. Existing projects surface a reset action where needed, and export validation rejects those legacy settings rather than reporting a false success.
